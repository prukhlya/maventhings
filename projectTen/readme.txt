 ...
 This will deploy two artifacts, target/projectTen.war and
 default-ds.xml.
 ...
 - http://localhost:8080/projectTen/
 ...
 Now you can either deploy the target/projectTen.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/projectTen.war

 To undeploy the application, run:

  ./asadmin undeploy projectTen
